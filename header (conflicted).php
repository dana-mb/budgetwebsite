<html>
  <head>
    ...
    /* the trash-bin icon at the end of each row in two of the tables */
    td > div:last-child {
      float: right;
      height: 19px;
      width: 25px;
    ...
    @media (max-width: 640px) {
      ...
      #hamburger {
        display: block;
        background: url("images/hamburger4.png") no-repeat;
        margin-top: 20px;
        margin-bottom: 0px;
        margin-left: 10px;
        width: 62px;
